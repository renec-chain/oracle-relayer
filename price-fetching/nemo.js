...
import { GAST, PLUS1, APS } from "../constants.js";
...
export const fetchAPSPriceFromNemo = async () => {
  const poolAddress = "BSNZxsuRWvoHMJAgoL8EbLvAHQ6T5wToFMqypwFnYiFA"; // APS/reUSD
  const inputMintAddress = APS.toBase58();
